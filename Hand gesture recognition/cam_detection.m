...
path('E:\Sem 5\Digital Image Processing\cv1-fingerspelling-recognition-master\lib\segmentation_method', path); % add lib folder to path
path('E:\Sem 5\Digital Image Processing\cv1-fingerspelling-recognition-master\lib\recognition', path); % add lib folder to path
path('E:\Sem 5\Digital Image Processing\cv1-fingerspelling-recognition-master\lib', path); % add lib folder to path
if nargout
